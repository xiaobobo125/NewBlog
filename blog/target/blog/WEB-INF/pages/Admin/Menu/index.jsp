...
<rapid:override name="content">
    ...
    <div class="layui-row">
        <div class="layui-col-md4">
            <form class="layui-form"  method="post" id="myForm" action="<%=request.getContextPath()%>/menu/insertSubmit">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        URL
                        <span style="color: #FF5722; ">*</span>
                        <input type="text" name="menuUrl" placeholder="如：http://www.baidu.com" autocomplete="off" class="layui-input" >
                    </div>
                    <br>
                    <div class="layui-input-block">
                        ...
                        <table class="layui-table" >
                            ...
                            <c:forEach items="${menuList}" var="m">
                                <tr>
                                    ...
                                    <td>
                                        <a href="<%=request.getContextPath()%>${m.menuUrl}" target="_blank">${m.menuUrl}</a>
                                    </td>
                                    <td>${m.menuOrder}</td>
                                    <td>
