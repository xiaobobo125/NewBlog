...
<rapid:override name="content">
    ...
    <div class="layui-row">
        <div class="layui-col-md4">
            <form class="layui-form"  method="post" id="myForm" action="<%=request.getContextPath()%>/tag/insertSubmit">
            ...
            <table class="layui-table" >
                ...
                <c:forEach items="${tagList}" var="c">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<%=request.getContextPath()%>/tag/edit/${c.tagId}" class="layui-btn layui-btn-mini">编辑</a>
                            <c:if test="${c.articleCount==0}">
                                <a href="<%=request.getContextPath()%>/tag/delete/${c.tagId}" class="layui-btn layui-btn-danger layui-btn-mini" onclick="return confirmDelete()">删除</a>
                            </c:if>
