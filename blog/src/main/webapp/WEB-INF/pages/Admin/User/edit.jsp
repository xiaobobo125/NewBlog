...
<rapid:override name="content">
    ...
    <br><br>
    <form class="layui-form" action="<%=request.getContextPath()%>/user/editSubmit" id="userForm"
          method="post">
            ...
            <div class="layui-input-inline">
                <div class="layui-upload">
                    <div class="layui-upload-list" style="">
                        <img class="layui-upload-img" src="<%=request.getContextPath()%>${user.userAvatar}" id="demo1" width="100"
                             height="100">
                        <p id="demoText"></p>
                    </div>
