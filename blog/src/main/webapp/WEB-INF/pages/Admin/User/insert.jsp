...
<rapid:override name="content">
    ...
    <br><br>
    <form class="layui-form" action="<%=request.getContextPath()%>/user/insertSubmit" id="userForm"
          method="post">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <div class="layui-upload">
                    <div class="layui-upload-list" style="">
                        <img class="layui-upload-img" src="<%=request.getContextPath()%>/upload/8f153264-95ea-4f19-b8f8-eb5f05d7d700.jpg" id="demo1" width="100"
                             height="100">
                        <p id="demoText"></p>
                    </div>
            ...
            <input type="hidden" name="userAvatar" id="userAvatar" value="/upload/8f153264-95ea-4f19-b8f8-eb5f05d7d700.jpg">
        </div>
        <div class="layui-form-item">
        ...
        layui.use('upload', function () {
            ...
            var uploadInst = upload.render({
                ...
                before: function (obj) {
                    ...
                    $("#userAvatar").attr("value", "/upload/"+res.data.title);
                    console.log(res);
                },
                error: function () {
