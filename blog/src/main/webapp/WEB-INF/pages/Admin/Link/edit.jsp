...
<rapid:override name="content">
    ...
    <div class="layui-row">
        <div class="layui-col-md4">
            <form class="layui-form" method="post" id="myForm" action="<%=request.getContextPath()%>/link/editSubmit">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        图片URL  <span style="color: #FF5722; ">*</span>
                        <input type="text" name="linkImage" value="${link.linkImage}" autocomplete="off" class="layui-input" required>
                    </div>
                    <br>
                    <div class="layui-input-block">
                        描述
            ...
            <table class="layui-table" >
                ...
                <c:forEach items="${linkList}" var="l">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<%=request.getContextPath()%>/link/edit/${l.linkId}" class="layui-btn layui-btn-mini">编辑</a>
                            <a href="<%=request.getContextPath()%>/link/delete/${l.linkId}" class="layui-btn layui-btn-danger layui-btn-mini" onclick="return confirmDelete()">删除</a>
                        </td>
                    </tr>
