...
<rapid:override name="content">
    ...
    <div class="layui-row">
        <div class="layui-col-md4">
            <form class="layui-form" method="post" id="myForm" action="<%=request.getContextPath()%>/link/insertSubmit">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="text" name="linkImage" autocomplete="off" class="layui-input" required>
                    </div>
                    <br>
                    <div class="layui-input-block">
                        描述
