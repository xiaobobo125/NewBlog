...
<rapid:override name="content">
    ...
    <form class="layui-form" action="<%=request.getContextPath()%>/options/editSubmit" method="post">
            ...
            <div class="layui-tab-item">
                    ...
                    <div class="layui-input-inline">
                        <div class="layui-upload">
                            <div class="layui-upload-list" style="">
                                <img class="layui-upload-img" src="<%=request.getContextPath()%>${option.optionAboutsiteAvatar}" id="demo1" width="100"
                                     height="100">
                                <p id="demoText"></p>
                            </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <div class="layui-upload">
                            <div class="layui-upload-list" style="">
                                <img class="layui-upload-img" src="<%=request.getContextPath()%>${option.optionAboutsiteWechat}" id="demo2" width="100"
                                     height="100">
                                <p id="demoText2"></p>
                            </div>
        ...
        layui.use('upload', function () {
            ...
            var uploadInst = upload.render({
                ...
                before: function (obj) {
                    ...
                    $("#optionAboutsiteAvatar").attr("value", "/upload/"+res.data.title);
                    if (res.code != 0) {
                        return ;
                    }
                },
        ...
        layui.use('upload', function () {
            ...
            var uploadInst = upload.render({
                ...
                before: function (obj) {
                    ...
                    $("#optionAboutsiteWechat").attr("value", "/upload/"+res.data.title);
                    if (res.code != 0) {
                        return ;
                    }
                },
